declare namespace Spicetify {
  ...
  namespace ContextMenu {
    type Icon =
      ...
      | "chromecast-connecting-one"
      | "chromecast-connecting-three"
      | "chromecast-connecting-two"
      ...
      | "paymenthistory"
      | "play"
      | "playback-speed-0point5x"
      | "playback-speed-0point8x"
      | "playback-speed-1point2x"
      | "playback-speed-1point5x"
      | "playback-speed-1x"
      | "playback-speed-2x"
      | "playback-speed-3x"
      | "playlist"
    ...
    class Item {
      ...
      constructor(
        ...
        shouldAdd: (uris: string[]) => boolean = (uris: string[]) => true,
        icon?: Icon,
        disabled?: boolean
      );
